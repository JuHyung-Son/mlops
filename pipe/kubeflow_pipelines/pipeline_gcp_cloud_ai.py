...
project_id = "peernet"  # <--- needs update by the user
...
#     "masterConfig": {
#         "imageUri": f"gcr.io/{project_id}/ml-pipelines-tfx-custom:0.22.0"
#     },
...
if __name__ == "__main__":
    ...
    tfx_image = os.environ.get(
        "KUBEFLOW_TFX_IMAGE",
        f"gcr.io/{project_id}/ml-pipelines-tfx-custom:0.22.0",
    )
